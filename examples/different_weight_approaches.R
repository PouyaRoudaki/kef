...
plot_data <- data.frame(sampled_x = sampled_x, weights_hat = as.vector(weights_hat_wo_grid_init$posterior_weights) , weights_hat_init = as.vector(weights_hat_wo_grid_init$initial_weights))
